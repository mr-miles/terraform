...
func (o *ConfigModuleCall) Instantiate(reg *Registry) ConfigObjectInstance {
	...
	instInsts := make(map[addrs.InstanceKey][]ConfigObjectInstance, len(o.InstanceKeys))
	regs := make(map[addrs.InstanceKey]*Registry, len(o.InstanceKeys))
...
func (o *ConfigModuleCallInstance) CheckState(prior, new *states.State) []error {
	...
	for _, key := range o.Obj.InstanceKeys {
